...
import PeriodicJobListView from "./components/periodic/PeriodicJobListView";
        ...
        <Switch>
          ...
          <LayoutWithLeftNavbar>
            <Switch>
              ...
              <Route
                exact
                path="/:organizationSlug/project/:projectId/periodic"
                component={requireServerConnection(PeriodicJobListView)}
              />
